...
let content = fs.readFileSync("packages/coding-agent/src/modes/interactive/interactive-mode.ts", "utf8");
...
fs.writeFileSync("packages/coding-agent/src/modes/interactive/interactive-mode.ts", content);
console.log("Done");
